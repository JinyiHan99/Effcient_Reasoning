...
class RefServer:
    def __init__(self, model_path, host='0.0.0.0', port=59887):
    ...
    def run_server(self): 
        ...
        def do_upload():
            ...
            if len(dd) == 7: data['gen_logps'] = bytes_to_tensor(dd[-1])
        ...
        bottle.run(self.app, host='0.0.0.0', port=59887, server='tornado')
    ...
    def start(self):
        ...
        while True:
            ...
            print('batch', len(data), d['inputs'].shape, d['rewards'], f' time: {time.time() - tic:.2f}s')
...
if __name__ == '__main__':
    ...
    RefServer(model_path="/mnt/data/kw/models/DeepSeek-R1-Distill-Qwen-7B").start()
